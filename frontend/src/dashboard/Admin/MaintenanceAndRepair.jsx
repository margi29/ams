  ...
  return (
    ...
    >
      ...
      <div className="flex gap-2 mb-4">
        ...
        <button className="bg-blue-500 text-white px-4 flex items-center gap-2 rounded-lg" onClick={() => exportData(filteredSchedule, exportFormat, "maintenance_and_repair")}>
          <FaDownload /> Export
        </button>
      </div>
